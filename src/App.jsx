		...
		<div>
			<div className='border-black border-1 rounded-2xl w-[97%] h-auto min-h-[30rem] bg-center mt-22 relative ml-2 md:ml-5 app'>
				...
				<button onClick={() => {
					...
					className='relative top-[15rem] ml-[4rem] w-auto h-auto bg-white  text-2xl rounded-xl pt-2 pb-2 pl-4 pr-4 hover:bg-gray-200 hover:shadow-2xl transition-transform duration-300 transform hover:scale-105 cursor-pointer'>
					Get Started</button>
			</div>
			...
			<div className='relative mt-10 w-[97%] md:ml-5 min-h-[20rem] flex flex-col items-center mb-10'>
				...
				<h2 className='mt-4 font-serif text-gray-600 sm:text-xl md:text-2xl lg:text-3xl ml-2'>Try a variety of benefits when using our cycle sharing service:</h2>
