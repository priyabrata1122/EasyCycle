		...
		<div>
			<div className='border-black border-1 rounded-2xl w-[97%] h-auto min-h-[30rem] bg-center mt-22 relative left-5 app'>
				...
				<button onClick={() => {
					...
					className='relative top-[15rem] left-[4rem] w-auto h-auto bg-white  text-2xl rounded-xl pt-2 pb-2 pl-4 pr-4 hover:bg-gray-200 hover:shadow-2xl transition-transform duration-300 transform hover:scale-105 cursor-pointer'>
					Get Started</button>
			</div>
